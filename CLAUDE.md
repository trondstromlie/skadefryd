...
Promptet ligger base64-encodet i koden (`_0x`-variabelen) og dekodes kun når datoen 30. september 2026 er passert. Ingen manuell handling kreves.

Utviklere som inspiserer kildekoden før den tid vil bare se en lang base64-streng. De som prøver å dekode den manuelt... vel, de har fortjent det.
